...
<table align="center" cellpadding="0" bgcolor="#FFFFFF" width="750" border="0">
  <tr>
    <td><h1 align="center" class="heading">Pregled prijavljenih ispita po ispitnom roku i profesoru</h1>
</p>
   </td>
  </tr> 
<form id="form1" name="form1" method="get" action="pregled21.php">
...
?>
        ...
        <table align="center" width="291" border="0">
          <tr>
            <td width="129"><strong>Profesor</strong></td>
            <td width="152"><!-- <input type="text" name="email" id="textfield3" />
-->
              <?PHP 
$link=mysqli_connect("localhost","root","","mydb") or die("Cannot Connect to the database!");
...
echo "Izaberite profesora</OPTION>"; 
while ($row = mysqli_fetch_array($result)){

$ime_prof= $row["ime"]; 
$prezime_prof= $row["prezime"];
$id_prof= $row["id_prof"]; 
echo "<OPTION value=\"$id_prof\">$ime_prof, $prezime_prof </OPTION>"; 
} 
echo '</SELECT>';
?></td>
          </tr>
